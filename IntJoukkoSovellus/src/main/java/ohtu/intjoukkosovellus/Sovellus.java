...
public class Sovellus {
    ...
    private static void yhdiste() {
        ...
        bJoukko = mikaJoukko();
        c = IntJoukko.palautaJoukkojenYhdiste(aJoukko, bJoukko);
    ...
    private static void leikkaus() {
        ...
        System.out.print("2. joukko? ");
        bJoukko = mikaJoukko();
        c = IntJoukko.palautaJoukkojenLeikkaus(aJoukko, bJoukko);
    ...
    private static void erotus() {
        ...
        System.out.print("2. joukko? ");
        bJoukko = mikaJoukko();
        c = IntJoukko.palautaJoukkojenErotus(aJoukko, bJoukko);
